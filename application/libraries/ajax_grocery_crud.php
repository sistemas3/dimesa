		...
		$js_text = "
			$(document).ready(function() {
				$($sourceElement).change(function() {
					...
					$.post(current_url+'/ajax_extension/$target_field/$relation_field_on_source_table/'+encodeURI(selectedValue.replace(/\//g,'$this->slash_replacement')), {}, function(data) {
					//alert('data'+data);
...
public function getStateInfo()
	...
	public function ajax_extension($state_info)
	{
